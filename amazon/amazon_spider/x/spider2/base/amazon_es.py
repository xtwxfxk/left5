...
class Amazon(object):
    ...
    CACHE_ROOT = 'I:\\cache_es'
    CACHE_EXPIRED_DAYS = 15

    best_url = 'https://www.amazon.es/gp/bestsellers'
    home_url = 'http://www.amazon.es'
    ...
    def __init__(self, **kwargs):
        ...
        Amazon.CACHE_ROOT = kwargs.get('CACHE_ROOT', 'I:\\cache_es')
        if not os.path.exists(Amazon.CACHE_ROOT):
            os.makedirs(Amazon.CACHE_ROOT)
