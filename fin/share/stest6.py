...
class Strategy:
    ...
    def __init__(self):
        ...
        df = ltdxhq.get_k_data_daily('600519', start='2020-09-01')
        ...
        for current_step in range(10, df.shape[0]):
            ...
            self.begin(self.scaler.fit_transform(obs)) # self.min_max_scaler.fit_transform(obs) # self.scaler.fit_transform(obs) # obs
