...
# symbols_keep = ['^SHFE.rb\d+$', '^SHFE.al\d+$', '^DCE.v\d+$', '^DCE.pp\d+$', '^DCE.m\d+$', '^DCE.c\d+$', '^DCE.b\d+$', '^DCE.a\d+$', '^CZCE.ma\d+$']
symbols_keep = ['^SHFE.rb\d+', '^SHFE.al\d+', '^DCE.v\d+$', '^DCE.pp\d+$', '^DCE.m\d+$', '^DCE.c\d+$', '^DCE.b\d+$', '^DCE.a\d+$', '^CZCE.ma\d+$', '^CZCE.sr\d+$', '^CZCE.rm\d+$', '^CZCE.cf\d+$']
#symbols_keep = ['^SHFE\.[a-zA-Z]+\d+$', '^DCE\.[a-zA-Z]+\d+$', '^CZCE\.[a-zA-Z]+\d+$']
