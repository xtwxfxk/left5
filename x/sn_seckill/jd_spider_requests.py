...
class QrLogin:
    ...
    def _get_qrcode(self):
        ...
        url = 'https://passport.suning.com/ids/qrLoginUuidGenerate.htm?image=true&yys=%s' % str(time.time() * 1000)[:-5]
        headers = {
...
class JdSeckill(object):
    ...
    def get_username(self):
        ...
        while True:
            try:
                ...
                profile_eles = x_data.xpath('//div[@class="profile-info"]//span')
    ...
    def get_sku_title(self):
        """获取商品名称"""
        url = 'https://product.suning.com/{}.html'.format(global_config.getRaw('config', 'sku_id'))
    ...
    #         'Referer': 'https://product.suning.com/{}.html'.format(self.sku_id),
    #     }
    #     while True:
    #         resp = self.session.get(url=url, headers=headers)
    #         resp_json = parse_json(resp.text)
    ...
    def request_seckill_url(self):
        ...
        self.session.get(
            url='https://product.suning.com/{}.html'.format(self.sku_id),
            headers=headers,
